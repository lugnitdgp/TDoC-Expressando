...
categories = {0: 'ZERO', 1: 'ONE', 2: 'TWO', 3: 'THREE', 4: 'FOUR', 5: 'FIVE', 6:'One', 7:'Two', 8:'Three', 9:'Blank'}
...
while True:
    ...
    cv2.putText(frame, prediction[0][0], (180, 130), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,255), 2)
